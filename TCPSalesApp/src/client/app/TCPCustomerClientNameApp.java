...
public class TCPCustomerClientNameApp {
	
public static void main (String[] args) {
		
		try {
			
			System.out.println("\tExecuting TCPCustomerClientNameApp");
			...
			String customerName = "Wani";
			dos.writeUTF(customerName);
			System.out.println("\tRequesting product name " + customerName + "\n");
